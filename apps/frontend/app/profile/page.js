...
export default function ProfilePage() {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      const response = await fetch('/api/user/profile', {
        ...
        body: JSON.stringify({
          name: userData.name,
          // organization removed - now read-only field
        }),
      });
  ...
  const handlePasswordUpdate = async (e) => {
    ...
    try {
      ...
      // Solo mostrar el modal, no el mensaje inline
        ...
        <div className="bg-white rounded-lg shadow-md">
          ...
          {profileSuccessMessage && (
            <div className="mx-6 mt-4 p-3 bg-green-50 border border-green-200 rounded-md">
              <p className="text-green-800 text-sm">{profileSuccessMessage}</p>
            </div>
          )}
          ...
          <form onSubmit={handleProfileUpdate} className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                ...
                />
                <p className="text-xs text-gray-500 mt-1">
                  Organization cannot be changed. Contact support if needed.
                </p>
              </div>
          ...
          <div className="bg-white rounded-lg p-8 max-w-md w-full mx-4 shadow-2xl transform transition-all">
            <div className="text-center">
              ...
              <p className="text-gray-600 mb-6">
                Tu contraseña ha sido cambiada exitosamente. Su cambio se ha guardado de forma segura.
              </p>

        ...
        <head>
          ...
          <style>
            ...
            .card {
              ...
              border-radius: 15px;
              position: relative;
              background: linear-gradient(120deg, rgba(127, 218, 212, 0.6) 0%, rgba(154, 230, 180, 0.6) 100%);
              overflow: hidden;
              padding: 0.2cm;
              box-sizing: border-box;
              display: flex;
            ...
            .leaf-pattern {
              ...
              top: 0;
              left: 0;
              background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100"><path d="M50 0C40 15 30 25 0 50C30 75 40 85 50 100C60 85 70 75 100 50C70 25 60 15 50 0Z" fill="white" fill-opacity="0.2"/></svg>');
              background-size: 50%;
